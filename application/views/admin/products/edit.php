...
<br>
<?php echo form_open_multipart('Products/products/update',array('id' => 'form')) ?>
<div class="row">
        ...
        <div class="card-box">
            ...
            <div class="form-group mb-3">
                ...
                <select class="form-control" name="type_product_id" required>
                	...
                	<option value="<?php echo $type_products['id'] ?>" 
                        <?php 
                            if ($detail['type_product_id'] == $type_products['id']) {
                                echo "selected";
                            }
                        ?>
                     ><?php echo $type_products['name'] ?></option>
                	<?php endforeach ?>
                </select>
            </div>
            <div class="form-group mb-3">
                ...
                <select class="form-control" id="divisionproduct" required>
                	...
                	<option value="<?php echo $divisionproduct['id'] ?>"
                        <?php 
                            if ($detail['division_id'] == $divisionproduct['id']) {
                                echo "selected";
                            }
                        ?>
                        ><?php echo $divisionproduct['name'] ?></option>
                	<?php endforeach ?>
                </select>
            </div>
            <div class="form-group mb-3">
                ...
                <select class="form-control" id="subcategoryproduct" name="sub_category_id" required>
                    ...
                    <?php foreach ($subcategory as $subcategory): ?>
                        <option value="<?php echo $subcategory['id'] ?>"
                            <?php 
                                if ($detail['subcategory_id'] == $subcategory['id']) {
                                    echo "selected";
                                }
                            ?>
    ...
    <div class="col-lg-6">
        ...
        <div class="card-box">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" id="barcode" name="barcode" class="form-control" placeholder="[Enter] for generate barcode" required value="<?php echo $detail['barcode'] ?>">
            </div>
            <div class="form-group mb-3">
                <label for="name">Name <span class="text-danger">*</span></label>
                <input type="text" id="name" max="50" class="form-control" name="name" placeholder="e.g : Apple iMac" required value="<?php echo $detail['name'] ?>">
            </div>
            <div class="form-group mb-3">
                <label for="short_name">Short Name (Max 25) <span class="text-danger">*</span></label>
                <input type="text" id="short_name" class="form-control" name="short_name" max="25" placeholder="e.g : Apple iMac" required value="<?php echo $detail['short_name'] ?>">
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <select required class="form-control" id="supplier" name="suppliers_id">
                	...
                	<option value="<?php echo $suppliers['id'] ?>"
                        <?php 
                        if ($detail['suppliers_id']== $suppliers['id'])  {
                            echo "selected";
                        }
                         ?>
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="pricing">
                    <div class="form-group mb-3">
                        ...
                        <input type="number" required id="purchase_price" name="purchase_price" class="form-control" placeholder="e.g : 15.000" value="<?php echo $detail['purchase_price'] ?>">

                    </div>
                    <?php $i = 0;foreach ($price as $price): ?>
                        <div class="form-group mb-3">
                        <label for="<?php echo strtolower(str_replace(' ', '_', $price['name'])) ?>"><?php echo $price['name'] ?> <span class="text-danger">*</span></label>
                        <input type="number" required id="<?php echo strtolower(str_replace(' ', '_', $price['name'])) ?>" name="<?php echo strtolower(str_replace(' ', '_', $price['name'])) ?>" class="form-control" placeholder="e.g : 15.000" value="<?php 
                        if(isset($detailPrice[$i]['price'])){
                            echo $detailPrice[$i]['price'];
                        }else{
                            echo "0";
                        } ?>">
                ...
                <div class="tab-pane show" id="image">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="fallback">
                                <input type="file" required name="photo[]" class="dropify" data-default-file="<?php echo base_url('uploads/images/products/'.$image['path']) ?>" />
                            </div>
                        </div>    
                        <?php endforeach ?>
                ...
                <div class="tab-pane" id="messages-b1">
                    <textarea class="form-control" name="description" id="description" required placeholder="Description"><?php echo $detail['description'] ?></textarea>
                </div>
            </div>
        </div> <!-- end card-box-->
    </div> <!-- end col -->
