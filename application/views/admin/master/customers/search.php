    ...
    <div class="col-xl-12" id="data_supplier">
        <div class="card">
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-sm-4">
                        <?php echo form_open('Admin/customers/search','class="form-inline"'); ?>
                            <div class="form-group mb-2">
                                <label for="search" class="sr-only">Search</label>
                                <input type="search" value="<?php echo $q ?>" class="form-control" name="search" id="search" placeholder="Search...">
                            </div>
                        <?php echo form_close() ?>
                    </div>
                    <div class="col-sm-8">
                        <div class="text-sm-right">
                            <?php echo anchor('Admin/customers/add','<i class="mdi mdi-plus-circle mr-1"></i> Add Supplier','class="btn btn-danger waves-effect waves-light mb-2" data-animation="fadein" data-overlayColor="#38414a"') ?>
                        </div>
                    </div><!-- end col-->
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-centered table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr data-id="<?php echo $customers['id'] ?>">
                                <td>
                                    <?php echo $i ?>
                                </td>
                                <td>
        ...
        <div class="card-box">
            <div class="media mb-3">
                ...
                <div class="media-body">
                    <h4 class="mt-0 mb-1" id="customers_name">Jade M. Walker</h4>
                    <p class="text-muted" id="customers_email">Branch manager</p>
                    <p class="text-muted"><i class="mdi mdi-office-building"></i> <p id="customers_phone"></p></p>

                    <!-- <a class="btn- btn-xs btn-info">Send Email</a> -->
                    <a class="btn- btn-xs btn-secondary" id="edit">Edit</a>
                    <a class="btn- btn-xs btn-danger" id="hapus">Hapus</a>
                    <a class="btn- btn-xs btn-success" id="riwayat">Sales History</a>
                </div>
            </div>
            ...
            <div class="">
                ...
                <p class="mb-3" id="customers_company"></p>

                <h4 class="font-13 text-muted text-uppercase mb-1">Added :</h4>
                <p class="mb-3" id="customers_created"> April 22, 2016</p>

                <h4 class="font-13 text-muted text-uppercase mb-1">Updated :</h4>
                <p class="mb-0" id="customers_edited"> Dec 13, 2017</p>
...
<script type="text/javascript">
    ...
    $(document).on('click','tbody tr',function(){
        ...
        $.ajax({
            url:'<?php echo base_url('Api/detailCustomers') ?>',
            type:'POST',
            data:value,
            success:function(data){
                ...
                if (json.response == 200) {
                    $.each(json.data, function(key,val){
                        ...
                        $('#customers_name').text(name);
                        $('#customers_email').text(email);
                        $('#customers_phone').text(phone);
                        $('#customers_company').text(name);
                        $('#customers_created').text(date_created);
                        $('#customers_edited').text(last_update);
                        $('#edit').attr('href','<?php echo base_url('Admin/customers/edit/') ?>'+id);
                        $('#hapus').attr('href','<?php echo base_url('Admin/customers/delete/') ?>'+id);
                        $('#riwayat').attr('href','<?php echo base_url('Admin/customers/sales_history/') ?>'+id);
                    });
