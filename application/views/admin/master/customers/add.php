...
<div class="row">
    <div class="col-lg-6">
        <div class="card-box">
            <h5 class="text-uppercase bg-light p-2 mt-0 mb-3">Information of customers</h5>
...
<div class="row">
    <div class="col-12">
        <div class="text-center mb-3">
            <?php echo anchor('Admin/customers','Back','class="btn w-sm btn-light waves-effect"') ?>
...
<script type="text/javascript">
    $(document).on('click','#btnSave',function(){
        ...
        Swal.fire({
                ...
                $.ajax({
                    url:'<?php echo base_url('Api/insertCustomers') ?>',
                    type:'POST',
                    data:value,
