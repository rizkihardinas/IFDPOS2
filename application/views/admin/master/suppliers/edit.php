...
<div class="row">
    <div class="col-lg-6">
        <div class="card-box">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" value="<?php echo $name ?>" class="form-control" placeholder="ex : Garuda Indonesia" id="name">
            </div>
            <div class="form-group mb-3">
                <label for="phone"> Phone <span class="text-danger">*</span></label>
                <input type="number" value="<?php echo $phone ?>" class="form-control" placeholder="ex : 0263 272739" id="phone">
            </div>
            <div class="form-group mb-3">
                <label for="email"> Email <span class="text-danger">*</span></label>
                <input type="email" value="<?php echo $email ?>" class="form-control" placeholder="ex : sample@gmail.com" id="email">
            </div>
        </div> <!-- end card-box -->
    </div> <!-- end col -->
    ...
    <div class="col-lg-6">
        ...
        <div class="card-box">
            ...
            <div class="form-group mb-3">
                <label for="disctrict_id"> Kota <span class="text-danger">*</span></label>
            ...
            <div class="form-group mb-3">
                <label for="subdisctrict_id"> Kecamatan <span class="text-danger">*</span></label>
            ...
            <div class="form-group mb-3">
                ...
                <input type="number" value="<?php echo $postal_code ?>" class="form-control" placeholder="ex : sample@gmail.com" id="postal_code">
            </div>
            <div class="form-group mb-3">
                <label for="address"> Alamat  <span class="text-danger">*</span></label>
                <textarea class="form-control" placeholder="ex : sample@gmail.com" id="address"><?php echo $address ?></textarea>
            </div>
        </div> <!-- end card-box -->
    </div> <!-- end col-->
</div>
