...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <table class="table table-hover m-0 table-centered dt-responsive nowrap w-100" id="table">
            <thead>
                <tr>
                    <th>No</th>
                    <th>Name</th>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="Cash">
                        </div>
                        <div class="form-group">
                            <label>
                                Charge
                            ...
                            <br>
                            <div class="form-horizontal radio radio-primary mb-2">
                                <input type="radio"  id="is_amount" value="amount" name="charge">
                                <label for="is_amount" class="control-label">Amount</label>
                            </div>
                            <div class="form-horizontal radio radio-primary mb-2">
                                <input type="radio" class="radio radio-primary mb-2" id="is_percent" value="percent" name="charge">
                            <label for="is_percent" class="control-label">Percent (%)</label>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#table').DataTable({
            ...
            "ajax":{
                "url": "<?php echo base_url('Api/getAllMaster/'.str_replace('_', '', $this->uri->segment(2)).'') ?>", // URL file untuk proses select datanya
                "type": "POST"
            }
        });
